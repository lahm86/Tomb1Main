...
static int32_t M_AnimChanges(const INJECTION *const injection, const int32_t data_count)
{
    LEVEL_INFO *const level_info = Level_GetInfo();
...
static int32_t M_AnimRanges(const INJECTION *const injection, const int32_t data_count)
{
    LEVEL_INFO *const level_info = Level_GetInfo();
    for (int32_t i = 0; i < data_count; i++) {
...
static int32_t M_AnimCommands(const INJECTION *const injection, const int32_t data_count)
{
    LEVEL_INFO *const level_info = Level_GetInfo();
    VFile_Read(
...
static int32_t M_AnimBones(const INJECTION *const injection, const int32_t data_count)
{
    LEVEL_INFO *const level_info = Level_GetInfo();
    VFile_Read(
...
static void M_AnimFrames(const INJECTION *const injection, const int32_t data_count)
{
    LEVEL_INFO *const level_info = Level_GetInfo();
...
static void M_Animations(const INJECTION *const injection, const int32_t data_count, const int32_t change_offset, const int32_t command_offset)
{
    LEVEL_INFO *const level_info = Level_GetInfo();
    for (int32_t i = 0; i < data_count; i++) {
...
static void M_AnimData(const INJECTION_SET *const set)
{
    ...
    for (int32_t i = 0; i < set->num_blocks; i++) {
        ...
        case IDT_ANIM_FRAMES:
            ...
            break;
        case IDT_ANIMS:
            anim_offset = M_Animations(set->injection, data_count, change_offset, cmd_offset);
            break;
        case IDT_OBJECTS:
            M_ObjectData(set->injection, data_count, )
        default:
