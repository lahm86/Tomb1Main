...
void Lara_Draw(ITEM *item)
{
    ...
    Output_DrawObjectMesh(Lara_GetMesh(LM_TORSO), clip);
    ...
    Output_DrawObjectMesh(Lara_GetMesh(LM_HEAD), clip);
    ...
    int32_t rate)
{
    ...
    Output_DrawInterpolatedObjectMesh(Lara_GetMesh(LM_HIPS), clip);
    ...
    Matrix_RotYXZ_I(
        g_Lara.interp.result.torso_rot.y, g_Lara.interp.result.torso_rot.x,
        g_Lara.interp.result.torso_rot.z);
    Output_DrawInterpolatedObjectMesh(Lara_GetMesh(LM_TORSO), clip);
    ...
    Matrix_RotYXZ_I(
        g_Lara.interp.result.head_rot.y, g_Lara.interp.result.head_rot.x,
        g_Lara.interp.result.head_rot.z);
    Output_DrawInterpolatedObjectMesh(Lara_GetMesh(LM_HEAD), clip);
